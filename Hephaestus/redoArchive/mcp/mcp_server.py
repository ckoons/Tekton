...
# Import new Phase 2 semantic query tools
from hephaestus.mcp.semantic_query_tools import (
    ui_semantic_query, ui_query_loading_states, ui_find_interactive, ui_query_by_state
)

# Import Phase 2 semantic state tools
from hephaestus.mcp.semantic_state_tools import (
    ui_inspect_state, ui_discover_actions, ui_map_relationships
)
...
TOOL_METADATA = {
    ...
    "ui_semantic_query": {
        "name": "ui_semantic_query",
        "description": "Query UI elements by semantic tags (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "query", "discovery"],
        "parameters": {
            "query": {
                "type": "object",
                "description": "CSS selector string or dict of tag:value pairs (e.g., {'component': 'rhetor', 'state': 'active'})",
                "required": True
            },
            "area": {
                "type": "string",
                "description": "UI area to search within",
                "required": False,
                "default": "hephaestus"
            },
            "wait_for": {
                "type": "string",
                "description": "Optional selector to wait for before querying",
                "required": False
            },
            "timeout": {
                "type": "integer",
            ...
            "return_content": {
                "type": "boolean",
                "description": "Whether to return element content",
                "required": False,
                "default": True
            }
        }
    },
    "ui_query_loading_states": {
        "name": "ui_query_loading_states",
        "description": "Query all loading states in the UI (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "loading", "state"],
        "parameters": {}
    },
    "ui_find_interactive": {
        "name": "ui_find_interactive",
        "description": "Find all interactive elements in an area (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "interactive", "discovery"],
        "parameters": {
            "area": {
                "type": "string",
                "description": "UI area to search",
                "required": False,
                "default": "hephaestus"
            },
            "type": {
                "type": "string",
                "description": "Optional type filter: button, input, link, form",
                "required": False
            }
        }
    },
    "ui_query_by_state": {
        "name": "ui_query_by_state",
        "description": "Query elements by their state attributes (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "state", "query"],
        "parameters": {
            "state_type": {
                "type": "string",
                "description": "Type of state to query (state, status, loading-state, etc.)",
                "required": True
            },
            "state_value": {
                "type": "string",
    ...
    "ui_inspect_state": {
        "name": "ui_inspect_state",
        "description": "Deep inspection of component state and semantic attributes (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "state", "inspection"],
        "parameters": {
            "component": {
                "type": "string",
                "description": "Component name or selector to inspect",
                "required": True
            },
            "include_children": {
                "type": "boolean",
                "description": "Whether to inspect child elements",
                "required": False,
                "default": True
            },
            "max_depth": {
                "type": "integer",
                "description": "Maximum depth for child inspection",
                "required": False,
                "default": 3
            },
            "use_source": {
                "type": "boolean",
                "description": "Whether to read from source files (True) or DOM (False)",
                "required": False,
                "default": True
            }
        }
    ...
    "ui_discover_actions": {
        "name": "ui_discover_actions",
        "description": "Discover all available actions and interactions in an area (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "actions", "discovery"],
        "parameters": {
            "area": {
                "type": "string",
                "description": "UI area to analyze",
            ...
            "include_handlers": {
                "type": "boolean",
                "description": "Whether to detect event handlers",
                "required": False,
                "default": True
            }
        }
    },
    "ui_map_relationships": {
        "name": "ui_map_relationships",
        "description": "Map component relationships and hierarchy (Phase 2)",
        "category": "ui",
        "tags": ["ui", "semantic", "relationships", "hierarchy"],
        "parameters": {
            "root_component": {
                "type": "string",
                "description": "Starting component (None for full UI)",
                "required": False
            },
            "max_levels": {
                "type": "integer",
...
async def execute_tool(request_data: Dict[str, Any]):
    ...
    tool_functions = {
        ...
        # New Phase 2 semantic query tools
        "ui_semantic_query": ui_semantic_query,
        "ui_query_loading_states": ui_query_loading_states,
        "ui_find_interactive": ui_find_interactive,
        "ui_query_by_state": ui_query_by_state,
        # Phase 2 semantic state tools
        "ui_inspect_state": ui_inspect_state,
        "ui_discover_actions": ui_discover_actions,
        "ui_map_relationships": ui_map_relationships
    }
