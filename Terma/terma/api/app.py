...
async def get_llm_providers():
    ...
    # TODO: Replace with Rhetor client
    providers = []  # This will fallback to config
    current_provider, current_model = None, None  # TODO: get from Rhetor
...
async def set_llm_provider_model(request: LLMSetRequest):
    ...
    llm_adapter = LLMAdapter()
    # TODO: Replace with Rhetor client
    # rhetor.set_provider_and_model(request.provider, request.model)
