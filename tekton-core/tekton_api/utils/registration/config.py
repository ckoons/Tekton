...
def find_config_file(component_id: str) -> Optional[str]:
    ...
    if tekton_root:
        ...
        config_dir = os.path.join(tekton_root, "config", "components")
    ...
    if tekton_root and os.path.exists(os.path.join(tekton_root, component_id)):
        component_dir = os.path.join(tekton_root, component_id)
